...
class CFG:
    ...
    base_dir = ""
    filename = 'liushuang_dataset.csv'
    embed_dim=768
    hidden_dim=768*2
    DEBUG = False
...
train_loader = DataLoader(train_dataset, batch_size=CFG.batch_size, shuffle=False, pin_memory=True,  num_workers=1)
valid_loader = DataLoader(valid_dataset, batch_size=CFG.batch_size, shuffle=False, pin_memory=True, num_workers=1)
